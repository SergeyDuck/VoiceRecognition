package com.example.voicerecognition.network

import com.example.voicerecognition.common.models.res.TextApp.isDebug
...
import com.example.voicerecognition.network.util.loggerPretty

class Client() :
    Closeable {

    companion object {
        const val BASE_URL: String = "http://171-25.dev.apidrom.ru:10502"
